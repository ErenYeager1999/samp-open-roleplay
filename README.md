...
1. ห้ามสร้างรายได้จากโหมดเกมนี้ (หมายถึงเอาสคริปต์นี้ไปขาย ยกเว้นคุณทำระบบขึ้นมาเองและขายส่วน ๆ นั้น)
2. ห้ามลบลายน้ำ
...
-   ไปที่ `gamemodes/configuration/` และเปลี่ยนชื่อ database.pwn.template เป็น database.pwn พร้อมตั้งค่าการเชื่อมต่อ
